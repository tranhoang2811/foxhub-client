 ...
 */
export declare type ShortHandEqualType =
  | string
  | number
  | boolean
  | Date
 ...
 * ```
 */
export declare type Where<MT extends object = Record<string, any>> =
  | Condition<MT>
  | AndClause<MT>
  | OrClause<MT>;
/**
 ...
 */
export declare type FilterExcludingWhere<
  MT extends object = Record<string, any>
> = Omit<IFilter<MT>, 'where'>;
/**
 * TypeGuard for Filter
 * @param candidate
 */
export declare function isFilter<MT extends object>(
  candidate: any
): candidate is IFilter<MT>;
/**
...
export declare function filterTemplate(
  strings: TemplateStringsArray,
  ...keys: any[]
): (ctx: Record<string, any>) => any;
